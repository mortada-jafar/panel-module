    ...
    $.fn.fileuploader.languages = {
        fa:{
            button: function (options) {
                return 'انتخاب ' + (options.limit == 1 ? 'فایل' : 'فایلها');
            },
            feedback: function (options) {
                return  (options.limit == 1 ? 'یک فایل ' : 'فایل ها ' ) + 'انتخاب کنید';
            },
            feedback2: function (options) {
                return options.length + ' ' + (options.length > 1 ? ' تا' : '') + ' فایل انتخاب شده';
            },
            confirm: 'تایید',
            cancel: "لغو",
            name: 'نام',
            ...
            download: 'دانلود',
            remove: 'حذف',
            drop: "پرونده ها را برای بارگذاری اینجا رها کنید",
            paste: '<div class="fileuploader-pending-loader"></div> Pasting a file, click here to cancel.',
            removeConfirmation: 'آیا مطمئن هستید که می خواهید این پرونده را حذف کنید؟',
            errors: {
                filesLimit: function (options) {
                    return 'Only ${limit} ' + (options.limit == 1 ? 'file' : 'files') + ' can be uploaded.'
                },
                filesType: 'فقط ${extensions} پرونده بارگذاری می شود.',
                fileSize: '${name} خیلی بزرگ است! لطفاً پرونده ای تا ${fileMaxSize} مگابایت را انتخاب کنید. ',
                filesSizeAll: 'پرونده های انتخاب شده خیلی بزرگ هستند! لطفاً پرونده های حداکثر ${maxSize} مگابایت را انتخاب کنید. ',
                fileName: 'فایلی با همین نام ${name} قبلاً انتخاب شده است.',
                remoteFile: 'پرونده های از راه دور مجاز نیستند',
